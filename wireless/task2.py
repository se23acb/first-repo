...
def topology(args):
    "Create a network."
    net = Mininet_wifi(link=wmediumd, wmediumd_mode=interference) #Mininet_wifi func with wireless links specified, simulate signal interference of wireless devices in range transmiting simultanoeusly
